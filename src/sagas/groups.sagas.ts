...
import { fetchGroupsAPI } from "../api/group";
import {
...
export function* watchGroupQueryChangedApproach1() {
  ...
  yield takeEvery(GROUPS_QUERY_APPROACH1, fetchGroupsApproach1);
}
...
export function* watchGroupQueryChangedApproach2() {
  console.log("watchGroupQueryChanged called");
  yield takeEvery(GROUPS_QUERY_APPROACH2, fetchGroupsApproach2);
}
...
export function* fetchGroupsApproach3(action: AnyAction): Generator<any> {
  ...
  yield put(QueryCompletedActionApproach3(action.payload, output));
}

export function* watchGroupQueryChangedApproach3() {
  console.log("watchGroupQueryChanged called");
  yield takeEvery(GROUPS_QUERY_APPROACH3, fetchGroupsApproach3);
}
